...
public class Vehiculo {
	...
	@Column(name = "vehi_fecha_importe")
	private LocalDateTime fechaImporte;
	...
	public LocalDateTime getFechaImporte() {
		return fechaImporte;
	}

	public void setFechaImporte(LocalDateTime fechaImporte) {
